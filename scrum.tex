  ...
  \item \uline{Setting the stage}:
    ...
    \item [Zweck]
      \begin{itemize}
        ...
        \item mach den Leuten Appetit auf den Hauptgang (\textit{Generate Insights})
      \end{itemize}
    \item [Start]
      \begin{itemize}
  ...
  \item \uline{Decide what to do next}:
    \begin{Beschreibungfett}[Zweck]
      ...
      \item [Start]
        ...
        \end{itemize}
    \end{Beschreibungfett}
  \item \uline{Check Out}:
    \begin{Beschreibungfett}[Zweck]
      \item [Zweck]
        \begin{itemize}
          \item Hilfe dem Team sich zu entscheiden, wie Sie die gelernten Erkenntnisse aus der
            Retro behalten können
          \item wie bei einem Hotel auschecken, Leute sollen kurzes Feedback geben und das Gefühl
            haben, dass dieses auch wahrgenommen werden
        \end{itemize}
      \item [Ablauf]
        \begin{itemize}
...
\begin{itemize}
  ...
  \item in einem Kreis sollen alle Teilnehmer ihren Namen mitsamt adjektiv nennen (z.B.
    \quote{Ich bin der majestitätische Matze})
...
\subsubsection{One Two Ping Four Pong}
\begin{itemize}
...
\begin{itemize}
  ...
  \item nun rufts du irgendwann das Wort \quote{Dreieck} und jeder Gruppenmitglied muss sich
...
\begin{itemize}
  ...
  \item Leute sollen irgendwie im Raum herumlaufen
  \item nun rufts du irgendwann das Wort \quote{Dreieck} und jeder fugleman muss
...
Der erste Teil zeigt eine selbstorg. Gruppe und das zweite Teil zeigt eine
...
\subsubsection{Following up on Action Items}
...
\subsubsection{DAKI - drop, add, keep, improve}
\begin{itemize}
  \item Flipchart in vier Bereiche aufteilen:
  \item Teilnehmer sollen sich Notizen zu den entsprechenden Bereichen machen
\end{itemize}
...
\begin{itemize}
  ...
  \item Teilnehmer sollen sich Notizen machen
  \item Gruppendiskussion machen
\end{itemize}


\subsubsection{3 Ls}
Fokus aufs Lernen anstatt in die Zukunft zu gucken
\begin{itemize}
  \item 3 Quadranten erstellen mit Liked, Lacked, and Learned.
  \item Teilnehmer sollen sich Notizen machen
  \item Gruppendiskussion machen
\end{itemize}
...
Fördere das Denken über Arbeitsweisen und wie viel Wert Sie von den einzelnen Teammitgliedern
entgegengebracht wird
\begin{itemize}
  \item Flipchart in 5 Bereiche gliedern: Keep doing, less of, more of, stop doing, start doing
  \item Notizen sammeln und anschließende Gruppendiskussion
\end{itemize}


\subsubsection{Small Starfish}
Fördere das Denken über Arbeitsweisen und wie viel Wert Sie von den einzelnen Teammitgliedern
entgegengebracht wird. Hierbei wird aber nicht auf die aktuellen Sachen geguckt
\begin{itemize}
  \item Flipchart in 5 Bereiche gliedern: Keep doing, less of, more of
  \item Notizen sammeln und anschließende Gruppendiskussion
\end{itemize}


\subsubsection{PMI - plus, minus, interesting}
Gucke dir eine Idee von mehrere Blickwinkeln aus an
\begin{itemize}
  \item Flipchart in drei Bereiche gliedern: plus, minus, interesting
  \item Thema formulieren, notizen machen und Gruppendiskussion
\end{itemize}
...
\subsubsection{Dieser Typ, jener Typ}
...
\subsubsection{Problems And Action}
Ist eine schnelle Methode zum Brainstorming, Ideenauswahl und Problemlösungsaktionen des
entsprechenden Teams


\begin{itemize}
  \item jeder Teilnehmer soll sein Problem auf einen post-it schreiben
  \item Teilnehmer sollen Ihre Probleme an den entsprechenden Bereich hängen
  \item nun sollen Teilnehmer individuell ihre Lösungsvorschläge zu den Problemen
    schreiben
  \item schreibe das Wort Actions neben den Problems, so dass die Leute ihre post-its
    daran hängen sollen
  \item führe eine offene Diskussion über Probleme und deren Lösungsvorschläge
\end{itemize}


\subsubsection{360 Grad Feedback}
\begin{itemize}
  \item Teile Papier aus und jeder soll über den anderen aufschreiben, was er an denjenigen
    schätzt (ca. 2 Minuten pro Teilnehmer)
  \item Gruppe soll einen Kreis bilden
  \item einer soll in die Mitte des Kreises gehen und die anderen sollen nun ihr Feedback
    über diese Person in der Mitte vorlesen
  \item solange widerholen, bis alle einmal dran wahren
\end{itemize}


\subsubsection{Thumbs Up, Thumbs Down, New ideas and Acknowledgement}
Teammitglieder sollen sich gegenseitig motivieren und auf die Schulter klopfen
\begin{itemize}
  \item Board in vier Bereiche teilen:
    \begin{itemize}
      \item Thumbs up: Dinge, die man mag
      \item Thumbs down: Dinge, die man nicht mag
      \item New Ideas: neue Dinge, die man mal ausprobieren will
      \item Acknowledgement: Danksagungen
    \end{itemize}
  \item Teilnehmer sollen Ihre Ergbenisse austauschen
\end{itemize}


\subsubsection{FLAP: Future direction, lessons learned, accomplishments and problem areas}
Gut für Projektretro, am besten sofort am Ende machen, bevor zu viel vergessen wurde

\begin{itemize}
  \item Quadranten vorbereiten
    \begin{itemize}
      \item Future: was soll in Zukunft betrachtet werden
      \item lessons learned: was haben wir von diesem Projekt gelernt und was können
        wir mitnehmen
      \item Accomplishments: welche Schlüsselstellen haben wir in diesem Projekt
        erledigt
      \item problem areas: Probs im ganzen Projekt oder in bestimmten
        Projektphasen
    \end{itemize}
  \item Teilnehmer sollen ihre Notizen machen und am besten für
    jeden Quadranten eine eigenständige Farbe verwenden unter
    den folgenden Themen verwenden
    \begin{itemize}
      \item Process und Arbeitsabläufe
      \item Technologie und Tools
      \item Umfang und Zeit
      \item Leute und Führung
    \end{itemize}
  \item Teilt Ergebnisse und
    führt eine Diskussion
\end{itemize}


\subsubsection{Dealing with Failure}
Systematische Analyse von sich ausgebreiteten Fehlern
\begin{itemize}
  \item Erkläre den Fehler unter Analyse Ablauf (am besten an einem Beispiel)
  \item Flipchart in folgende Bereiche aufteilen:
    \begin{itemize}
      \item Analysis: Was genau ist der Fehlschlag? Was hat zu ihm geführt?
      \item Evaluation: Was sind die Konzequenzen aus diesem Fehlschlag? Wie hoch
        ist di Gefahr (severity, wie hoch stehen die Chancen, dass so was
        nocchmal passiert)
      \item Action: Was sind Problemvermeidungskativitäten
      \item Verifikation: nachdem wir mögliche Lösungen haben, wie
        können wir ihren Ausgang bestimmten)
    \end{itemize}
  \item Gruppe aufteilen und Zeit zum Schreiben lassen
    und anschließende Grupppendiskussion führen
\end{itemize}


\subsubsection{Letters to the Future (Futurespective)}
Gut, wenn das Team in die Zukunft blicken muss und dabei reflektieren soll

\begin{itemize}
  \item Frag die Teilnehmer über die gegenwärtige Situation nachzudenken und dass sie einen Brief
    in die Zukunfr an eine Person schreiben sollen (PO, ein anderes Teammitglied, jemanden der
    geeignet ist)
  \item nun schreiben die Teilnehmer ein bis zwei Sätze, wobei der Inhalt frei wählbar ist
  \item die Brief sollen vorgelesen und diskutiert werden
\end{itemize}


\subsubsection{RAID - Risks, Assumptions, Issues and Dependencies (Futurespective)}
\begin{itemize}
  \item bereite Flipchart mit den entsprechenden Bereichen vor
  \item Teilnehmer sollen sich Notizen zu den entsprechenden Themen machen
  \item offene Diskussion über die Themen
\end{itemize}


\subsubsection{Hopes and Concerns (Futurespective)}
Gut, damit sich Leute öffnen
\begin{itemize}
  \item Teile Flipchart in die Bereiche Hopes und Concerns
  \item Teilnehmer sollen sich Notizen machen  zu Hopes und Converns für den Workshop,
    Zeitrahmen, Zeitpunkt
  \item Diskussion über Ergebnisse
\end{itemize}


\subsubsection{Heros Journey (Futurespective)}
Gut für ein Team, die eine Story zu erledigen haben.

\begin{itemize}
  \item Einleitung: Wir sind hier, um gemeinsam unsere Heldengeschichte zu schreiben
  \item Fokus der Geschichte: Der Held (Person oder Gruppe, die durchs Abenteuer geht), der Führer (Leute und Karten, die den Helden leiten), die Höhle (die anstehenden Herausforderungen), der Schatz (die Belohnung)
  \item Ideen aufschreiben und anschließende Gruppendiskussion
\end{itemize}
